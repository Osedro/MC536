## Questão 1
Construa um comando SELECT que retorne dados equivalentes a este XPath
~~~xquery
...
for $i in ($publicacoes/publications/publication[year>2011])
let $ano := $i/@year
group by $ano
...
~~~xquery
let $dron := doc('https://raw.githubusercontent.com/santanche/lab2learn/master/data/faers-2017-dron/dron.xml')
return {data($dron//drug[drug/drug/@name='FLUDROCORTISONE']/@name)}
~~~
